...
The current working course syllabus is available in [`SYLLABUS.md`](SYLLABUS.md). Canvas will remain the official course home; this repository hosts the independent interactive opening and its public syllabus draft.
...
At baggage claim, the normal Continue action remains locked until the student distinguishes their suitcase from several similar bags. A memory of checking the bag in with Mom supplies the clue: she tied a small red ribbon to the handle after the student insisted they would recognize their own luggage. The correct suitcase carries that ribbon; plausible lookalikes invite inspection without being labeled as wrong in advance. The next arrivals-hall scene asks the student to locate the information desk, ask natural-language questions, and choose bus, shuttle, or taxi to the brother's apartment. A visible three-route fallback ensures the experience never depends on a conversational response. Taxi is the marked story route, while every choice deducts its fare from the A$50 wallet and carries the resulting balance forward.
