...
- Eleven scenes: boot, baggage claim, main arrivals, transit, brother's apartment, optional bar below, walk, mall, vendor, console, and Virtual Kyoto
...
- Replaced the time jump with an interactive brother's-apartment scene. A continuous original Web Audio soundscape shifts between a loud bar mix (beat, bass, percussion, and indistinct voices) and its muffled transmission through the bedroom floor. The student can mute it with earplugs, use the house keys to visit the bar below, inspect the glasses/gloves/empty console, and must read the brother's note before unlocking the walk.
