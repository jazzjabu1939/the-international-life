...
- Replaced the time jump with an interactive brother's-apartment scene. The student can mute the shared bar music with earplugs, use the house keys to visit the bar below, inspect the glasses/gloves/empty console, and must read the brother's note before unlocking the walk.
