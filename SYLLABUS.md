# The International Life — Fall 2026
...
- distinguish a packaged account of a place from one grounded in lived experience, attention, and ethical source work;
...
- create an original **Sixth Tape**: a small researched portrait of a place that mattered to a real person.

## The three First-Year Seminar practices

- **Demystify College:** make advising, office hours, feedback, assignments, language study, internships, study abroad, and campus resources visible and usable.
- **Make Connections:** build relationships through Tape Card introductions, structured peer dialogue, a campus-resource encounter, and an ethical conversation with a human source.
- **Maintain Balance:** use attention, quiet, Buddhist philosophy in Taiwan and Korea, and the Temple Pause to examine how ambition can remain humane and sustainable.

## How your learning will be assessed

The course uses a simple 100-point structure:

- Seminar presence and contribution — **25 points**
- Six short Tape Notes — **20 points**
- Global Pathway Map — **20 points**
...
This is a small seminar. Its substance is produced partly through listening, conversation, and the presence of other people. If you must miss a meeting, contact me and we will identify a reasonable way to recover the important work. Two missed meetings may be recovered through short alternative responses.

For smaller assignments, you may use two automatic 48-hour extensions during the semester without explaining why. If a larger difficulty arises, contact me early so that we can make the available options visible.
